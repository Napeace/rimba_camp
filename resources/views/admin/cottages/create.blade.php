...
@section('title', 'Tambah Cottage - Rimba Camp')
...
<body class="bg-gray-100">
    ...
    <div class="max-w-4xl mx-auto py-8 px-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Tambah Cottage Baru</h2>
            <p class="text-gray-600">Isi form di bawah untuk menambah cottage baru</p>
        </div>

        <!-- Form -->
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.cottages.store') }}" method="POST" id="cottageForm">
                @csrf
                ...
                <div class="mt-6">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3" id="facilitiesCheckboxes">
                            <label class="flex items-center">
                                <input type="checkbox" class="facility-checkbox mr-2" value="AC">
                                <span class="text-sm">AC</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" class="facility-checkbox mr-2" value="TV">
                                <span class="text-sm">TV</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" class="facility-checkbox mr-2" value="Kamar Mandi Dalam">
                                <span class="text-sm">Kamar Mandi Dalam</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" class="facility-checkbox mr-2" value="Teras">
                                <span class="text-sm">Teras</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" class="facility-checkbox mr-2" value="Wifi">
                                <span class="text-sm">Wifi</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" class="facility-checkbox mr-2" value="Lemari Es">
                                <span class="text-sm">Lemari Es</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" class="facility-checkbox mr-2" value="Dapur Kecil">
                                <span class="text-sm">Dapur Kecil</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" class="facility-checkbox mr-2" value="Dapur Lengkap">
                                <span class="text-sm">Dapur Lengkap</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" class="facility-checkbox mr-2" value="Ruang Tamu">
                                <span class="text-sm">Ruang Tamu</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" class="facility-checkbox mr-2" value="BBQ Area">
                                <span class="text-sm">BBQ Area</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <textarea id="fasilitas"
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('fasilitas') border-red-500 @enderror">{{ old('fasilitas') }}</textarea>
                    @error('fasilitas')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-6" id="previewCard">
                        <div class="flex items-start justify-between">
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    <h4 class="text-xl font-bold text-gray-800" id="previewNomor">-</h4>
                                    <p class="text-gray-600" id="previewKapasitas">- orang</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="text-2xl font-bold text-green-600" id="previewHarga">Rp -</p>
                ...
                <div class="flex justify-end space-x-4 mt-8">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-2"></i>Simpan Cottage
                    </button>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('fasilitas').addEventListener('input', function() {
                const facilitiesText = this.value;
